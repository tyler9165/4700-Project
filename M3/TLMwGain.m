...
plot(time*1e12,real(OutputL),'m');
plot(time*1e12,imag(OutputL),'c');
plot(time*1e12,InputL,'y');
ylabel('Output')
xlabel('time (ps)')
...
subplot(4,1,2);
plot(omega,abs(fftOutputR),'r');hold on
plot(omega,abs(fftInputR),'g');
plot(omega,abs(fftOutputL),'m');hold on
%plot(omega,abs(fftInputL),'b');
ylabel('abs In/Out')
xlabel('omega')
xlim([-13427700000000,15039100000000])
hold off

subplot(4,1,3);
plot(omega,unwrap(angle(fftOutputR)),'r');hold on
plot(omega,unwrap(angle(fftInputR)),'g');
plot(omega,unwrap(angle(fftOutputL)),'m');
plot(omega,unwrap(angle(fftInputL)),'b');
xlabel('Omega')
ylabel('Phase')
hold off
